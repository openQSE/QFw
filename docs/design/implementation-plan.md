...
long as the resulting work still follows the QFw design intent and records the
reason in the commit body or implementation notes.

Authentication work is deferred. This plan keeps token parameters as unchecked
placeholders.
...
`docs/design/qfw.md` define the architecture and flow. Requirement design
...
| --- | --- | --- |
| Phase 1. Directory And Transport Foundation | [Build And Installation Model](qfw.md#build-and-installation-model); [DEFw Directory And Identity Model](qfw.md#defw-directory-and-identity-model); [Connection Establishment Flow](qfw.md#connection-establishment-flow); [Peer Lifecycle Events](qfw.md#peer-lifecycle-events); [Heartbeat Policy](qfw.md#heartbeat-policy); [Service Registration Flow](qfw.md#service-registration-flow); [DEFw Registration Infrastructure Changes](qfw.md#defw-registration-infrastructure-changes); [Heartbeat And Liveness Flow](qfw.md#heartbeat-and-liveness-flow); [Service Deregistration Flow](qfw.md#service-deregistration-flow); [Directory Service Scope And Resolver Policy](qfw.md#directory-service-scope-and-resolver-policy) | [OPM-001](qfw.md#opm-001); [OPM-003](qfw.md#opm-003); [DISC-001](qfw.md#disc-001); [DISC-002](qfw.md#disc-002); [DISC-004](qfw.md#disc-004); [CAT-005](qfw.md#cat-005); [CTRL-004](qfw.md#ctrl-004) |
| Phase 2. QPM Endpoint Resolution And Operation Modes | [DEFw Directory And Identity Model](qfw.md#defw-directory-and-identity-model); [Connection Establishment Flow](qfw.md#connection-establishment-flow); [DEFw Registration Infrastructure Changes](qfw.md#defw-registration-infrastructure-changes); [Directory Service Scope And Resolver Policy](qfw.md#directory-service-scope-and-resolver-policy); [QPM Override Handling](qfw.md#qpm-override-handling); [Integration Sequence](qfw.md#integration-sequence) | [OPM-001](qfw.md#opm-001); [OPM-002](qfw.md#opm-002); [OPM-003](qfw.md#opm-003); [DISC-003](qfw.md#disc-003); [DISC-004](qfw.md#disc-004); [DISC-005](qfw.md#disc-005); [API-003](qfw.md#api-003) |
| Phase 3. API Categories, Token Placeholders, And Client Pass-Through | [Managed Resource Model](qfw.md#managed-resource-model); [QFw API Categories](qfw.md#qfw-api-categories); [Token Placeholder For Current Milestone](qfw.md#token-placeholder-for-current-milestone); [Admission Policy Configuration APIs](qfw.md#admission-policy-configuration-apis); [Scheduler Control APIs](qfw.md#scheduler-control-apis); [Admission Control APIs](qfw.md#admission-control-apis); [Execution APIs](qfw.md#execution-apis); [Synchronous Execution Contract](qfw.md#synchronous-execution-contract); [Telemetry And Discovery APIs](qfw.md#telemetry-and-discovery-apis); [Identifier Allocation And Mapping](qfw.md#identifier-allocation-and-mapping) | [CAT-001](qfw.md#cat-001) through [CAT-007](qfw.md#cat-007); [API-001](qfw.md#api-001) through [API-004](qfw.md#api-004) |
| Phase 4. QPM Controller Runtime Scaffolding | [Admission And Scheduler Integration](qfw.md#admission-and-scheduler-integration); [QPM Override Handling](qfw.md#qpm-override-handling); [Integration Sequence](qfw.md#integration-sequence); [Identifier Allocation And Mapping](qfw.md#identifier-allocation-and-mapping) | [STATE-001](qfw.md#state-001) through [STATE-004](qfw.md#state-004); [SCHED-002](qfw.md#sched-002); [SCHED-003](qfw.md#sched-003); [SCHED-009](qfw.md#sched-009); [SCHED-010](qfw.md#sched-010); [CAT-007](qfw.md#cat-007) |
| Phase 5. Admission Control And Reservation Store Integration | [Admission And Scheduler Integration](qfw.md#admission-and-scheduler-integration); [Token Placeholder For Current Milestone](qfw.md#token-placeholder-for-current-milestone); [Admission Policy Configuration APIs](qfw.md#admission-policy-configuration-apis); [Admission Control APIs](qfw.md#admission-control-apis); [Integration Sequence](qfw.md#integration-sequence); [Identifier Allocation And Mapping](qfw.md#identifier-allocation-and-mapping) | [ADM-001](qfw.md#adm-001) through [ADM-007](qfw.md#adm-007); [ADM-016](qfw.md#adm-016) through [ADM-022](qfw.md#adm-022); [CAT-003](qfw.md#cat-003); [CTRL-005](qfw.md#ctrl-005); [CTRL-006](qfw.md#ctrl-006); [API-004](qfw.md#api-004) |
| Phase 6. Scheduler Integration And Managed Execution | [Admission And Scheduler Integration](qfw.md#admission-and-scheduler-integration); [Scheduler Control APIs](qfw.md#scheduler-control-apis); [Execution APIs](qfw.md#execution-apis); [Synchronous Execution Contract](qfw.md#synchronous-execution-contract); [Integration Sequence](qfw.md#integration-sequence); [Identifier Allocation And Mapping](qfw.md#identifier-allocation-and-mapping) | [SCHED-001](qfw.md#sched-001) through [SCHED-014](qfw.md#sched-014); [CAT-002](qfw.md#cat-002); [CAT-004](qfw.md#cat-004); [API-001](qfw.md#api-001); [API-004](qfw.md#api-004) |
| Phase 7. Telemetry, Reconciliation, And Hardening | [Telemetry And Discovery APIs](qfw.md#telemetry-and-discovery-apis); [Admission And Scheduler Integration](qfw.md#admission-and-scheduler-integration); [Peer Lifecycle Events](qfw.md#peer-lifecycle-events); [Heartbeat Policy](qfw.md#heartbeat-policy); [Heartbeat And Liveness Flow](qfw.md#heartbeat-and-liveness-flow); [Service Deregistration Flow](qfw.md#service-deregistration-flow); [Integration Sequence](qfw.md#integration-sequence) | [CAT-005](qfw.md#cat-005); [API-002](qfw.md#api-002); [API-004](qfw.md#api-004); [CTRL-002](qfw.md#ctrl-002) through [CTRL-008](qfw.md#ctrl-008); [STATE-004](qfw.md#state-004); [SCHED-013](qfw.md#sched-013); [SCHED-014](qfw.md#sched-014) |
| Phase 8. Installation And Runtime Startup Model | [Installation And Runtime Startup Model](qfw.md#installation-and-runtime-startup-model); [Installation Paths](qfw.md#installation-paths); [Activation](qfw.md#activation); [DEFw Python Entry Point](qfw.md#defw-python-entry-point); [Runtime Roles](qfw.md#runtime-roles); [Deployment Modes](qfw.md#deployment-modes); [Site Configuration](qfw.md#site-configuration) | [OPM-001](qfw.md#opm-001); [OPM-002](qfw.md#opm-002); [OPM-003](qfw.md#opm-003); [DISC-001](qfw.md#disc-001); [DISC-003](qfw.md#disc-003); [DISC-004](qfw.md#disc-004); [DISC-005](qfw.md#disc-005); [API-003](qfw.md#api-003) |
| Phase 9. Per-Reservation Completion Queues | [Execution APIs](qfw.md#execution-apis); [Per-Reservation Completion Queues](qfw.md#per-reservation-completion-queues); [Synchronous Execution Contract](qfw.md#synchronous-execution-contract); [Integration Sequence](qfw.md#integration-sequence); [Identifier Allocation And Mapping](qfw.md#identifier-allocation-and-mapping) | [CAT-002](qfw.md#cat-002); [API-001](qfw.md#api-001); [API-004](qfw.md#api-004); [ADM-021](qfw.md#adm-021); [SCHED-005](qfw.md#sched-005); [SCHED-006](qfw.md#sched-006); [SCHED-011](qfw.md#sched-011); [SCHED-012](qfw.md#sched-012); [STATE-001](qfw.md#state-001); [STATE-002](qfw.md#state-002); [STATE-003](qfw.md#state-003); [STATE-004](qfw.md#state-004) |
| Phase 10. Reservation-Scoped Provider Credentials | [Device Access Configuration](qfw.md#device-access-configuration); [Reservation-Scoped Provider Credentials](qfw.md#reservation-scoped-provider-credentials); [Admission Control APIs](qfw.md#admission-control-apis); [Execution APIs](qfw.md#execution-apis); [Synchronous Execution Contract](qfw.md#synchronous-execution-contract); [Telemetry And Discovery APIs](qfw.md#telemetry-and-discovery-apis); [Integration Sequence](qfw.md#integration-sequence) | [ADM-001](qfw.md#adm-001); [ADM-002](qfw.md#adm-002); [ADM-003](qfw.md#adm-003); [ADM-004](qfw.md#adm-004); [ADM-005](qfw.md#adm-005); [ADM-021](qfw.md#adm-021); [CAT-003](qfw.md#cat-003); [CAT-005](qfw.md#cat-005); [API-001](qfw.md#api-001); [API-002](qfw.md#api-002); [API-003](qfw.md#api-003); [API-004](qfw.md#api-004) |
...
| PH3-C05 | QFw | PH3.6, PH3.7 | Add metadata access placeholders and API/token-pass-through tests. Authentication-provider work is deferred. |
...
1. PH1.1 Replace SCons with CMake for DEFw.
   - Implement the
     [Build And Installation Model](qfw.md#build-and-installation-model)
...
7. PH1.7 Fix C heartbeat and liveness coverage.
   - Implement the [Heartbeat Policy](qfw.md#heartbeat-policy)
     from the detailed design.
...
The full authentication feature is deferred to future work.
...
Caller-token validation remains deferred to future authentication work.
